  ...
  admin.pages.fileEditor = function () {
    $(document).ready(function () {
      ...
      $(".copy-expiration-settings").on("click", function () {
        copySettingsToCheckboxes(
          $(this),
          ".checkbox_setting_expires",
          json_strings.translations.upload_form.copy_expiration,
        );
        // Copy date
      ...
      $(".copy-public-settings").on("click", function () {
        copySettingsToCheckboxes(
          $(this),
          ".checkbox_setting_public",
          json_strings.translations.upload_form.copy_public,
        );
      });
      ...
      $(".copy-hidden-settings").on("click", function () {
        copySettingsToCheckboxes(
          $(this),
          ".checkbox_setting_hidden",
          json_strings.translations.upload_form.copy_hidden,
        );
      });
