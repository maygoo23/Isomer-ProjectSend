...
define('TABLE_DISCIPLINE', TABLES_PREFIX . 'discipline');
define('TABLE_DELIVERABLE_TYPE', TABLES_PREFIX . 'deliverable_type');
define('TABLE_ISSUE_STATUS', TABLES_PREFIX . 'issue_status');
define('TABLE_TRANSMITTAL_SUMMARY', TABLES_PREFIX . 'transmittal_summary');
